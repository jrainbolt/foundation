...
typedef enum {
    ...
    FACTORY_ENTITY_TYPE_REACTOR_CORE,
    FACTORY_ENTITY_TYPE_HEAT_CONDUCTOR,
    FACTORY_ENTITY_TYPE_HEAT_EXCHANGER,
    FACTORY_ENTITY_TYPE_STEAM_TURBINE,
    FACTORY_ENTITY_TYPE_STEAM_CONDENSER,
    FACTORY_ENTITY_TYPE_RESEARCH_LAB,
    FACTORY_ENTITY_TYPE_CONSTRUCTION_DEPOT,
    FACTORY_ENTITY_TYPE_RAIL,
    FACTORY_ENTITY_TYPE_RAIL_STATION,
    FACTORY_ENTITY_TYPE_RAIL_SWITCH,
    FACTORY_ENTITY_TYPE_LOCOMOTIVE,
    FACTORY_ENTITY_TYPE_CARGO_WAGON,
    FACTORY_ENTITY_TYPE_RAIL_SIGNAL
} FactoryEntityType;
