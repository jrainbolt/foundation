...
storage, accepts aqueous fluids, and permits all four cardinal directions.
...
Snapshot version 6 stores pipe entity IDs and positions plus the existing
...
equalization, flow animation, steam, boilers, heat, chemistry, oil processing,
nuclear systems, pollution, or research.
