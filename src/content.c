...
static const FactoryEntityDefinition entities[] = {
    ...
    {FACTORY_ENTITY_TYPE_RAIL,FACTORY_CONSTRUCTION_COST_RAIL,1U,1U,0,0U,FACTORY_CONTENT_RECIPE_FAMILY_NONE,0U,0U,0U},
    ...
    {FACTORY_ENTITY_TYPE_RAIL_CHAIN_SIGNAL,
        FACTORY_CONSTRUCTION_COST_RAIL_CHAIN_SIGNAL,1U,1U,0,
        FACTORY_UNLOCK_ADVANCED_MANUFACTURING,
        FACTORY_CONTENT_RECIPE_FAMILY_NONE,0U,0U,0U}
};
...
static const FactoryAssemblerRecipe assembler_recipes[] = {
    ...
    {FACTORY_ASSEMBLER_RECIPE_BASIC_SCIENCE,
        {FACTORY_ITEM_IRON_GEAR,FACTORY_ITEM_ELECTRONIC_COMPONENT},{1U,1U},2U,
        FACTORY_ITEM_BASIC_SCIENCE,1U,
        FACTORY_ASSEMBLER_ELECTRONIC_COMPONENT_TICKS,FACTORY_UNLOCK_NONE}
};
...
bool factory_content_validate_view(const FactoryContentView *v)
{
    ...
    if(v==NULL||v->entities==NULL||v->entity_count==0U
        ||v->entity_count!=(size_t)FACTORY_ENTITY_TYPE_RAIL_CHAIN_SIGNAL
    ...
    for(size_t i=0U;i<v->entity_count;++i){const FactoryEntityDefinition*d=&v->entities[i];
        if(d->entity_type<=FACTORY_ENTITY_TYPE_NONE
            ||d->entity_type>FACTORY_ENTITY_TYPE_RAIL_CHAIN_SIGNAL
