...
static const FactoryEntityDefinition entities[] = {
    ...
    {FACTORY_ENTITY_TYPE_ASSEMBLER,FACTORY_CONSTRUCTION_COST_ASSEMBLER,1U,1U,0,FACTORY_UNLOCK_AUTOMATION,FACTORY_CONTENT_RECIPE_FAMILY_ASSEMBLER,1U,0U,0U},
    ...
    {FACTORY_ENTITY_TYPE_SPLITTER,FACTORY_CONSTRUCTION_COST_SPLITTER,1U,1U,0,FACTORY_UNLOCK_AUTOMATION,FACTORY_CONTENT_RECIPE_FAMILY_NONE,0U,0U,0U},
    {FACTORY_ENTITY_TYPE_INSERTER,FACTORY_CONSTRUCTION_COST_INSERTER,1U,1U,0,FACTORY_UNLOCK_AUTOMATION,FACTORY_CONTENT_RECIPE_FAMILY_NONE,1U,0U,0U},
    ...
    {FACTORY_ENTITY_TYPE_FLUID_TANK,FACTORY_CONSTRUCTION_COST_FLUID_TANK,1U,1U,FACTORY_CONTENT_ORIENTATION_NONE,FACTORY_UNLOCK_FLUID_HANDLING,FACTORY_CONTENT_RECIPE_FAMILY_NONE,0U,1U,0U},
    {FACTORY_ENTITY_TYPE_PIPE,FACTORY_CONSTRUCTION_COST_PIPE,1U,1U,FACTORY_CONTENT_ORIENTATION_NONE,FACTORY_UNLOCK_FLUID_HANDLING,FACTORY_CONTENT_RECIPE_FAMILY_NONE,0U,2U,0U},
    {FACTORY_ENTITY_TYPE_WATER_EXTRACTOR,FACTORY_CONSTRUCTION_COST_WATER_EXTRACTOR,1U,1U,FACTORY_CONTENT_ORIENTATION_NONE,FACTORY_UNLOCK_FLUID_HANDLING,FACTORY_CONTENT_RECIPE_FAMILY_FLUID,0U,4U,0U},
    {FACTORY_ENTITY_TYPE_BOILER,FACTORY_CONSTRUCTION_COST_BOILER,1U,1U,FACTORY_CONTENT_ORIENTATION_NONE,FACTORY_UNLOCK_FLUID_HANDLING,FACTORY_CONTENT_RECIPE_FAMILY_FLUID,0U,12U,0U},
    {FACTORY_ENTITY_TYPE_STEAM_ENGINE,FACTORY_CONSTRUCTION_COST_STEAM_ENGINE,1U,1U,FACTORY_CONTENT_ORIENTATION_NONE,FACTORY_UNLOCK_FLUID_HANDLING,FACTORY_CONTENT_RECIPE_FAMILY_STEAM,2U,8U,0U},
    ...
    {FACTORY_ENTITY_TYPE_HEAT_EXCHANGER,FACTORY_CONSTRUCTION_COST_HEAT_EXCHANGER,1U,1U,FACTORY_CONTENT_ORIENTATION_NONE,FACTORY_UNLOCK_FLUID_HANDLING,FACTORY_CONTENT_RECIPE_FAMILY_FLUID,0U,12U,4U},
    {FACTORY_ENTITY_TYPE_STEAM_TURBINE,FACTORY_CONSTRUCTION_COST_STEAM_TURBINE,1U,1U,FACTORY_CONTENT_ORIENTATION_NONE,FACTORY_UNLOCK_FLUID_HANDLING,FACTORY_CONTENT_RECIPE_FAMILY_STEAM,2U,12U,0U},
...
static const FactoryAssemblerRecipe assembler_recipes[] = {
    ...
    {FACTORY_ASSEMBLER_RECIPE_IRON_GEAR,
        ...
        FACTORY_ITEM_IRON_GEAR,1U,FACTORY_ASSEMBLER_ELECTRONIC_COMPONENT_TICKS},
...
bool factory_content_validate_view(const FactoryContentView *v)
{
    ...
    for(size_t i=0U;i<v->assembler_recipe_count;++i){const FactoryAssemblerRecipe*d=&v->assembler_recipes[i];
        if(d->recipe_id==FACTORY_ASSEMBLER_RECIPE_NONE||d->input_count==0U
            ...
            ||d->output_amount==0U||d->processing_ticks==0U)return false;
